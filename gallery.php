					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner mt-4">
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">นาย ธเนศ หนักไหล่</strong></h5>
								<h6 class="text-dark m-0">Web Master , Web developer</h6>
								<p class="m-0 pt-3">ระดับชั้น ปวส.2/1 สาขา เทคโนโลยีสารสนเทศ รุ่นที่ 5 เลขที่ 7</p>
							</div>
							<div class="carousel-item text-center">
								...
								<p class="m-0 pt-3">ระดับชั้น ปวส.2/1 สาขา เทคโนโลยีสารสนเทศ รุ่นที่ 5 เลขที่ 15</p>
							</div>
						</div>
